...
namespace IIS.Itogovaya_tochno
{
    ...
    public class ЗаказПост : IIS.Itogovaya_tochno.ОтчетОЗак
    {
        ...
        public override IIS.Itogovaya_tochno.СостОтгрузки СостОтгрузки
        {
            get
            {
                ...
                IIS.Itogovaya_tochno.СостОтгрузки result = base.СостОтгрузки;
        ...
        public override IIS.Itogovaya_tochno.СостОплаты СостояниеОплаты
        {
            get
            {
                ...
                IIS.Itogovaya_tochno.СостОплаты result = base.СостояниеОплаты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПостE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостE", typeof(IIS.Itogovaya_tochno.ЗаказПост));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПостL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПостL", typeof(IIS.Itogovaya_tochno.ЗаказПост));
                }
            }
        }
    }
