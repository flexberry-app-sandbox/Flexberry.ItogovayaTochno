...
namespace IIS.Itogovaya_tochno
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovaya_tochno.Номенклатура fНоменклатура;
        
        private IIS.Itogovaya_tochno.ОтчетОЗак fОтчетОЗак;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Itogovaya_tochno.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Itogovaya_tochno.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itogovaya_tochno.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.Itogovaya_tochno.ЗаказПост",
                "IIS.Itogovaya_tochno.ОтчетОЗак"})]
        public virtual IIS.Itogovaya_tochno.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.Itogovaya_tochno.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Itogovaya_tochno.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itogovaya_tochno.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Itogovaya_tochno.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Itogovaya_tochno.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.Itogovaya_tochno.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Itogovaya_tochno.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itogovaya_tochno.ТЧЗаказ dataobject)
        {
