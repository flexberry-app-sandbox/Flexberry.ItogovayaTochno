...
namespace IIS.Itogovaya_tochno
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itogovaya_tochno.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itogovaya_tochno.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Itogovaya_tochno.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Itogovaya_tochno.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Itogovaya_tochno.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itogovaya_tochno.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Itogovaya_tochno.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Itogovaya_tochno.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Itogovaya_tochno.План this[int index]
        {
            get
            {
                return ((IIS.Itogovaya_tochno.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itogovaya_tochno.План dataobject)
        {
