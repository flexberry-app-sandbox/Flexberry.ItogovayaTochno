...
moduleForModel('i-i-s-itogovaya-tochno-единицы-измер', 'Unit | Serializer | i-i-s-itogovaya-tochno-единицы-измер', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-tochno-единицы-измер',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
