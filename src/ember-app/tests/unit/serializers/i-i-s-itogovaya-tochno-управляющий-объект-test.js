...
moduleForModel('i-i-s-itogovaya-tochno-управляющий-объект', 'Unit | Serializer | i-i-s-itogovaya-tochno-управляющий-объект', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-itogovaya-tochno-управляющий-объект',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
